...
sap.ui.define(
  [
    'ui/s2p/mm/stock/overview/opt2/controller/BaseController',
    'sap/ui/model/json/JSONModel',
    'ui/s2p/mm/stock/overview/opt2/model/formatter',
    'sap/ui/model/Filter',
    'sap/ui/model/FilterOperator',
    'sap/ui/core/format/NumberFormat',
    'sap/m/MessageToast',
    'ui/s2p/mm/stock/overview/opt2/reuse/materialmaster/controller/ValueHelpController',
    'sap/ui/generic/app/navigation/service/NavigationHandler',
    'ui/s2p/mm/stock/overview/opt2/reuse/custom/LightDialog',
    'ui/s2p/mm/stock/overview/opt2/reuse/custom/ChartPersonalizationLight',
    'ui/s2p/mm/stock/overview/opt2/reuse/custom/HistoryChartLight',
    'external/Chartjs'
  ],
  function (B, J, f, F, b, N, M, V, c, LightDialog, ChartPersonalizationLight, HistoryChartLight, Chart) {
    'use strict';
    return B.extend('ui.s2p.mm.stock.overview.opt2.controller.S1', {
      formatter: f,
      onInit: function () {
        var t = this;
        ...
        var p = { container: 'ui.s2p.mm.stock.overview.opt2', item: 'app' };
      ...
      onCopilot: function (e) {
        ...
        if ((s.length === 1 && s[0].data.Type !== 'total') || e.getParameter('id') === 'idBtnCopilot') {
          ...
          if (!this._oCopilotPopover) {
            this._oCopilotPopover = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.opt2.view.CoPilotChatPopover', this);
      ...
      handleSpecialStockLinkPressed: function (e) {
        ...
        if (!this._oPopover) {
          this._oPopover = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.opt2.view.SpecialStockPopover', this);
      ...
      handlePersoButtonPressed: function (e) {
        if (!this._oPersDialog) {
          this._oPersDialog = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.opt2.view.personalization', this);
      ...
      handleColumnSettingsPressed: function (e) {
        if (!this._oColumnSettingsDialog) {
          this._oColumnSettingsDialog = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.opt2.view.column_setting', this);
      ...
      handleViewSettingsDialogButtonPressed: function (e) {
        if (!this._oSettingsDialog) {
          this._oSettingsDialog = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.opt2.view.settings', this);
