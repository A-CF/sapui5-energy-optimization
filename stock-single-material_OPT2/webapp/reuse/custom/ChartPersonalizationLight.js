...
sap.ui.define([
    ...
    "use strict";
    return Control.extend("ui.s2p.mm.stock.overview.opt2.reuse.custom.ChartPersonalization", {
        metadata: {
            properties: {
        ...
        */
        init: function () {
            this._i18n = new sap.ui.model.resource.ResourceModel({
                bundleUrl: jQuery.sap.getModulePath('ui.s2p.mm.stock.overview.opt2') + '/i18n/i18n.properties',
            });
