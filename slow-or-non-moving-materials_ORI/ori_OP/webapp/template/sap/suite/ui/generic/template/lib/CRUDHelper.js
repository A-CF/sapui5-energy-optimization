sap.ui.define(["sap/ui/base/Object", "sap/ui/model/Context", "sap/suite/ui/generic/template/lib/MessageUtils", "sap/ui/model/Filter", "sap/ui/model/FilterOperator"],
	function(BaseObject, Context, MessageUtils, Filter, FilterOperator) {
		...
		function create(oDraftController, sEntitySet, sBindingPath, oModel, oApplication, vPredefinedValues, sRootExpand, oController, oApplicationController, bUseNewActionForCreate) {
			sBindingPath = sBindingPath || "/" + sEntitySet;
			var bCreateRequestsCanonical = oApplication.mustRequireRequestsCanonical();
			return oDraftController.createNewDraftEntity(sEntitySet, sBindingPath, vPredefinedValues, bCreateRequestsCanonical, sRootExpand, oController, oApplicationController, bUseNewActionForCreate).then(function(oResponse) {
