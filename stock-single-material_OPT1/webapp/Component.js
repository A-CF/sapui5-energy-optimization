...
sap.ui.define(
  [
    ...
    'sap/ui/Device',
    'ui/s2p/mm/stock/overview/opt1/model/models',
    'ui/s2p/mm/stock/overview/opt1/controller/ErrorHandler',
  ],
  function (U, D, m, E) {
    'use strict';
    return U.extend('ui.s2p.mm.stock.overview.opt1.Component', {
