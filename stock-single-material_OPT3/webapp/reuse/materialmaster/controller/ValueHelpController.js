...
sap.ui.define(
  ...
  function (C, V, G, M, F, a, L, S, b, c, t, T, d) {
    'use strict';
    return C.extend('ui.s2p.mm.stock.overview.opt3.reuse.materialmaster.controller.ValueHelpController', {
      init: function (m) {
        if (m) {
          this._oModel = m;
        } else {
        ...
        this._i18n = new sap.ui.model.resource.ResourceModel({
          bundleUrl: jQuery.sap.getModulePath('ui.s2p.mm.stock.overview.opt3.reuse.materialmaster') + '/i18n/i18n.properties',
        });
      ...
      initMaterialGeneralValueHelpDialog: function () {
        this.oMaterialGeneralValueHelpDialog = sap.ui.xmlfragment(
          'ui.s2p.mm.stock.overview.opt3.reuse.materialmaster.fragments.selectMaterial',
          this
        );
      ...
      displayValueHelpPlant4Material: function (p, f, o) {
        ...
        if (!this._oPlantDialog) {
          this._oPlantDialog = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.opt3.reuse.materialmaster.fragments.selectPlant', this);
      ...
      displayValueHelpAUOM4Material: function (p, f, o) {
        ...
        if (!this._oAUOMDialog) {
          this._oAUOMDialog = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.opt3.reuse.materialmaster.fragments.selectAUoM', this);
      ...
      displayValueHelpStorageLocation4Material: function (p, f, o) {
        ...
        if (!this._oStorageLocationDialog) {
          this._oStorageLocationDialog = sap.ui.xmlfragment(
            'ui.s2p.mm.stock.overview.opt3.reuse.materialmaster.fragments.selectStorageLocation',
            this
          );
      ...
      displayValueHelpCostCenter4Plant: function (p, f) {
        this._oCostCenterDialog = sap.ui.xmlfragment(
          'ui.s2p.mm.stock.overview.opt3.reuse.materialmaster.fragments.selectCostCenter',
          this
        );
