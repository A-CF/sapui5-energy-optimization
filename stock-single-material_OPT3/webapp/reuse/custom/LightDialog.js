...
sap.ui.define([
    ...
    "use strict";
    return Control.extend("ui.s2p.mm.stock.overview.opt3.reuse.custom.LightDialog", {
        metadata: {
            properties: {
        ...
        */
        init: function () {
            ...
            this.materialHeaders.forEach((header) => {
        ...
        */
        searchMaterial: function () {
            this.resultTable.bindRows({
                ...
                parameters: {
                    select: this.materialHeaders.map((t) => t.template).join(","),
                    custom: {
                        "sap-client": "300",
