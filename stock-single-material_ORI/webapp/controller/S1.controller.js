...
sap.ui.define(
  [
    'ui/s2p/mm/stock/overview/ori/controller/BaseController',
    'sap/ui/model/json/JSONModel',
    'ui/s2p/mm/stock/overview/ori/model/formatter',
    'sap/ui/model/Filter',
    'sap/ui/model/FilterOperator',
    'sap/ui/core/format/NumberFormat',
    'sap/m/MessageToast',
    'ui/s2p/mm/stock/overview/ori/reuse/materialmaster/controller/ValueHelpController',
    'sap/ui/generic/app/navigation/service/NavigationHandler',
    'sap/viz/ui5/format/ChartFormatter',
    'sap/viz/ui5/api/env/Format',
  ],
  function (B, J, f, F, b, N, M, V, c, C, d) {
    'use strict';
    return B.extend('ui.s2p.mm.stock.overview.ori.controller.S1', {
      formatter: f,
      onInit: function () {
        var t = this;
        ...
        var p = { container: 'ui.s2p.mm.stock.overview.ori', item: 'app' };
      ...
      onCopilot: function (e) {
        ...
        if ((s.length === 1 && s[0].data.Type !== 'total') || e.getParameter('id') === 'idBtnCopilot') {
          ...
          if (!this._oCopilotPopover) {
            this._oCopilotPopover = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.ori.view.CoPilotChatPopover', this);
      ...
      onChartPersonalizationPress: function (e) {
        if (!this._oChartPersDialog) {
          this._oChartPersDialog = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.ori.view.personalizationChart', this);
          this.getView().addDependent(this._oChartPersDialog);
          jQuery.sap.syncStyleClass('sapUiSizeCompact', this.getView(), this._oChartPersDialog);
        }
      ...
      onVizFrameSelectData: function (e) {
        var v = e.getSource();
        var D = sap.ui.getCore().byId('idBtnDrillDown');
        var o = this.getView().getModel('oFrontend');
      ...
      _successDayHistoryLoad: function (p, e, s, S, D, r) {
        if (!this._oHistoryChartDialog) {
          this._oHistoryChartDialog = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.ori.view.history_chart', this);
          this.getView().addDependent(this._oHistoryChartDialog);
          jQuery.sap.syncStyleClass('sapUiSizeCompact', this.getView(), this._oHistoryChartDialog);
        }
      ...
      _displayHistoryChart: function (p, s, S) {
        ...
        var x = sap.ui.getCore().byId('idBtnDrillDown');
        var y = sap.ui.getCore().byId('idBtnDrillUp');
        ...
        var A = sap.ui.getCore().byId('idChartContainer');
        var T = sap.ui.getCore().byId('idTxtChartContainerDrillDown');
        T.setVisible(true);
      ...
      handleSpecialStockLinkPressed: function (e) {
        ...
        if (!this._oPopover) {
          this._oPopover = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.ori.view.SpecialStockPopover', this);
      ...
      handlePersoButtonPressed: function (e) {
        if (!this._oPersDialog) {
          this._oPersDialog = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.ori.view.personalization', this);
      ...
      handleColumnSettingsPressed: function (e) {
        if (!this._oColumnSettingsDialog) {
          this._oColumnSettingsDialog = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.ori.view.column_setting', this);
      ...
      handleHistoryChartDisplay: function (e, I) {
        ...
        v.addFeed(y);
        this._oHistoryChartDialog.setModel(u);
        var z = this;
        ...
        var G = sap.ui.getCore().byId('idBtnDrillDown');
        var K = sap.ui.getCore().byId('idBtnDrillUp');
        G.setEnabled(true);
        K.setEnabled(false);
        G.setTooltip();
        var T = sap.ui.getCore().byId('idTxtChartContainerDrillDown');
      ...
      handleViewSettingsDialogButtonPressed: function (e) {
        if (!this._oSettingsDialog) {
          this._oSettingsDialog = sap.ui.xmlfragment('ui.s2p.mm.stock.overview.ori.view.settings', this);
