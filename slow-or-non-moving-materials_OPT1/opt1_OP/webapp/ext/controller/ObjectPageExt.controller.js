...
sap.ui.define([
	...
	"use strict";
	var sControllerName = "ui.s2p.mm.lib.slonomo.mat.opt1.ext.controller.ObjectPageExt";
	sap.ui.controller(sControllerName, {
		...
		_setStockSituationPopoverData: function (oEvent) {
			...
			if (!aSelectedItems[0].data.hasOwnProperty(this._sMeasureStockConsumption)) {
				...
				if (!this._oMovementPopover) {
					this._oMovementPopover = sap.ui.xmlfragment("ui.s2p.mm.lib.slonomo.mat.opt1.ext.fragment.MovementPopover", this);
